 ...
 * Description:       Al publicarse una nota, genera con Gemini los posteos para X, Facebook e Instagram, los deja en una cola de aprobación y los publica en cada red (manual o automático).
 * Version:           1.0.0
...
// Constantes.
// ---------------------------------------------------------------------------
define( 'VD_SOCIAL_VERSION', '1.0.0' );
